// Adjacency Matrices (adapted from Bostock)

function make_adjMatGr() {
...
var tip = d3.tip()
    ...
    var svg = d3.select("#corrmatGrD3").append("svg")
...
//make_adjMat();
  ...
  d3.json("js/corrmat/EPI1_Group_corrmat.json", function(error, json) {
...
window.setTimeout(function() {
 d3.json("js/corrmat/EPI2_Group_corrmat.json", function(error, json) {
  if (error) return console.warn(error);
  data = json;
  make_adjMatGr();
 }); 
